#!/usr/bin/python
###############################################################################
# Salesforce application module
# 25-Jan-2021, Patrick Timmons
###############################################################################
...
URL = 'https://stat.ripe.net/data/announced-prefixes/data.json?resource=AS14340'
...
formatted JSON output as /var/run/128technology/application-module/salesforce.json
