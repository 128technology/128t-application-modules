...
URL = 'https://stat.ripe.net/data/announced-prefixes/data.json?resource=AS46489'
...
formatted JSON output as /var/run/128technology/application-module/netflix.json
